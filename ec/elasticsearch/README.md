...
| <a name="output_apm_secret_token"></a> [apm\_secret\_token](#output\_apm\_secret\_token) | APM secret token |
| <a name="output_cloud_id"></a> [cloud\_id](#output\_cloud\_id) | Elasticsearch stack cloud id |
