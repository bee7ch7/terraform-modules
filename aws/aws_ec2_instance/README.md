...
| <a name="input_attach_eip"></a> [attach\_eip](#input\_attach\_eip) | Attach EIP to the instance | `bool` | `false` | no |
...
| <a name="output_eip"></a> [eip](#output\_eip) | EIP for the instance |
